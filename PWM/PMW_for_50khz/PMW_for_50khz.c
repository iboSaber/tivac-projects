...
/* PWM1 module and PWM generator 3 of PWM1 module is used */
    ...
    int main()
    {
       ...
       /* Clock setting for PWM and GPIO PORT */
               ...
               PWM1_3_LOAD_R = 320; /* set load value for 100kHz (16MHz/1600) */
//               PWM1_3_CMPA_R = 319; /* set duty cyle to 50% by loading of 16000 to PWM1CMPA */
//                       GPIO_PORTF_DATA_R &= ~(1 << 1);
        ...
        // increase ADC constant by 320
                if(adc_value < 80 ){PWM1_3_CMPA_R = 319;} // 0% duty Cycle

                else if(adc_value < 280){ PWM1_3_CMPA_R = 288;} // 10% duty Cycle

                else if(adc_value < 480){ PWM1_3_CMPA_R = 256;} // 20% duty Cycle

                else if(adc_value < 680){ PWM1_3_CMPA_R = 244;} // 30% duty Cycle

                else if(adc_value < 880){ PWM1_3_CMPA_R = 192;} // 40% duty Cycle

                else if(adc_value < 1080){ PWM1_3_CMPA_R = 160;} // 50% duty Cycle

                else if(adc_value < 1280){ PWM1_3_CMPA_R = 128;} // 60% duty Cycle

                else if(adc_value < 1480){ PWM1_3_CMPA_R = 96;} // 70% duty Cycle

                else if(adc_value < 1680){ PWM1_3_CMPA_R = 64;} // 80% duty Cycle

                else if(adc_value < 1880){ PWM1_3_CMPA_R = 32;} // 90% duty Cycle
